...
// middleware 
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:5174', 'https://bazario-bbb0f.web.app'],
    credentials: true
  }));
...
// mongodb+srv://user:123@cluster0.3ywizof.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
